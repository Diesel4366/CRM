  ...
  return (
    <div className="space-y-6">
      ...
      <form action={saveSettingsAction} className="space-y-6">
        ...
        {/* Transport */}
        <div className="rounded-xl border bg-white p-6 space-y-4">
          <h2 className="text-base font-semibold border-b pb-2">Транспорт</h2>

          <div className="space-y-1 max-w-xs">
            <label className="block text-sm font-medium text-gray-700">Цена топлива, ₽/л</label>
            <input
              name="fuel_price"
              type="number"
              min="0"
              step="0.01"
              defaultValue={settings.fuel_price ?? ''}
              className="w-full rounded-lg border border-gray-200 px-3 py-2 text-sm outline-none focus:border-gray-400 focus:ring-2 focus:ring-gray-200"
              placeholder="65.50"
            />
            <p className="text-xs text-gray-400">Используется для расчёта расхода ГСМ по выездам</p>
          </div>
        </div>
